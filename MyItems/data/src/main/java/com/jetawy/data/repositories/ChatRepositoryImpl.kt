...
class ChatRepositoryImpl @Inject constructor(private val fbs: FirebaseChatService): ChatRepository {
    ...
    override suspend fun createChatRoom(
       ...
       return  fbs.createChatRoom(message, sender, receiver, foundItemID)
    }
