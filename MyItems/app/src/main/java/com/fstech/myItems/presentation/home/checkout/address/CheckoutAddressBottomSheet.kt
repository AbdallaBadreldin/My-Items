package store.msolapps.flamingo.presentation.home.checkout.address
...
class CheckoutAddressBottomSheet : BottomSheetDialogFragment(), AddressBottomSheetNavigator {
    ...
    override fun onCreateView(
        ...
        binding.addAddressBottomSheetBtn.setOnClickListener {
            val action =
                CheckoutAddressBottomSheetDirections.actionCheckoutAddressBottomSheetToMapFragment2(
                    false
                )
