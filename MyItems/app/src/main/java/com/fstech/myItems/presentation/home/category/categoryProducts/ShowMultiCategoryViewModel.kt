...
@HiltViewModel
class ShowMultiCategoryViewModel @Inject constructor(
    private val getDeepCategoryHomeUseCase: GetDeepCategoryHomeUseCase,
    ...
    fun getCategories(multiCats: MutableList<Long>) {
        viewModelScope.launch {
            val request =
                DeepMultiCatsRequest(psp.getLang(), multiCats, "01")
            getDeepCategoryHomeUseCase.invoke(
                request
